// ignore_for_file: file_names, depend_on_referenced_packages, unused_import, avoid_function_literals_in_foreach_calls, avoid_unnecessary_containers, unnecessary_string_interpolations, sized_box_for_whitespace

import 'dart:async';
import 'package:flutter/material.dart';
import 'package:beamer/beamer.dart';
import 'package:p/models/HomePhoneModel.dart';
import 'package:p/repository/finestore_service.dart';
import 'package:p/screens/notes/AddHomePhoneForm.dart';
...
class NoteHomePhoneDetailScreenState extends State<NoteHomePhoneDetailScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Домофоны - Список домофонов'),
      ),
      body: StreamBuilder(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          setState(() {
            showDialog(
                context: context,
                builder: (context) => const AddHomePhoneForm());
          });
        },
